...
export class PageAdminMovieEdit extends AdminPageTemplate {
  ...
  async main() {
    ...
    const img = data.thumbnail
      ? `/img/movie-thumbnails/${data.thumbnail}`
      : "/img/default.webp";
                  ...
                  data.id
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="number" min="0" max="10" step="1" class="form-control" id="duration_hours" placeholder="" value="${Math.floor(
                              data.duration / 60
                            )}">
                        </div>
                        <div class="col-sm-6">
                            <label for="duration_minutes" class="form-label">minutes</label>
                            <input type="number" min="0" max="59" step="1" class="form-control" id="duration_minutes" placeholder="" value="${
                              data.duration % 60
                            }">
                        </div>
