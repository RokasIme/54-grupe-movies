...
pageRouter.get("/movies", async (req, res) =>
  res.send(await new PageMovies(req).render())
);
pageRouter.get("/movies/:movieTitle", async (req, res) =>
  res.send(await new PageMovieInner(req).render())
);
pageRouter.get("/movies-by-category", async (req, res) =>
  res.send(await new PageCategories(req).render())
);
pageRouter.get("/movies-by-category/:categoryName", async (req, res) =>
